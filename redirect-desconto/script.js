var data = [
  ...
  { id: '', type: 'allin', color: '#3f297e', text: '20%', ikon: 'grade' },
  { id: '', type: 'quiz', color: '#1d61ac', text: '22%' },
  { id: '', type: 'quiz', color: '#169ed8', text: '25%' },
  { id: '', type: 'quiz', color: '#209b6c', text: '30%' },
  { id: '', color: '#60b236', text: '27%', ikon: 'stars' },
  { id: '', color: '#efe61f', text: '20%' },
  { id: '', color: '#f7a416', text: '17%' },
  { id: '', type: 'time', color: '#e6471d', text: '+15', ikon: 'timer' },
  { id: '', type: 'question', color: '#dc0936', text: '0%' },
  { id: '', color: '#e5177b', text: '10%' },
  { id: '', color: '#be107f', text: '5%' },
  { id: '', type: 'replay', color: '#881f7e', text: 'SPIN +1x', ikon: 'replay' }
];
